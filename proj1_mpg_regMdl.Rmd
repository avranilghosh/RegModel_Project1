...
Even the highest absolute correlation of 84.6% here is lower than the lowest of the above 3 regressions for a single predictor at 88.4% since including additional variables will increases the actual standard errors of coefficient estimates of other correlated predictors.
